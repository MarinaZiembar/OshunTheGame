        ...
        <div className="scene-1">
            <main className="animate__animated animate__fadeIn">
                ...
                <div className="scene-1-textblock">
                    <div>
                        <p className="scene-1-dialog animate__animated animate__fadeIn" id="1">Puedo sentir tu presencia ahi afuera...</p>
                        <p className="scene-1-dialog animate__animated animate__fadeIn" id="2">No tengas miedo, pasa. </p>
                    </div>
                    <div>
